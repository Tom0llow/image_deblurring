...
from score_based_model.kernel.utils import get_kernel_score_model, save_samples
...
def sampling(ckpt_path, path_to_save, filename, device="cuda"):
    ...
    score_model = get_kernel_score_model(ckpt_path, marginal_prob_std_fn, device=device)
